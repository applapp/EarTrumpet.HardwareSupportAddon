...
{
    class MIDIFeedbackWizardViewModel : BindableBase
    {
        public string Title { get; private set; }
        public ICommand SaveMidiCommandFeedback { get; }
        ...
        public MIDIFeedbackWizardViewModel(string title, HardwareSettingsViewModel hardwareSettings)
        {
            _hardwareSettings = hardwareSettings;

            Title = title;

            SaveMidiCommandFeedback = new RelayCommand(SaveMidiControl);
